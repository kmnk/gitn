...
if v:version > 703 || v:version == 703 && has('patch1170')
  function! vital#_gitn#Vim#Message#import() abort
  ...
  execute join(['function! vital#_gitn#Vim#Message#import() abort', printf("return map({'capture': '', 'echomsg': '', 'echo': '', 'warn': '', 'get_hit_enter_max_length': '', 'error': ''}, \"function('<SNR>%s_' . v:key)\")", s:_SID()), 'endfunction'], "\n")
  delfunction s:_SID
endif
" ___vital___
let s:save_cpo = &cpo
