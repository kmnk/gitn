...
if v:version > 703 || v:version == 703 && has('patch1170')
  function! vital#_gitn#VCS#Git#import() abort
    return map({'_vital_depends': '', 'get_config': '', 'find': '', 'get_finder_cache': '', 'get_finder': '', 'set_config': '', 'new': '', '_vital_loaded': ''},  'function("s:" . v:key)')
  endfunction
else
  function! s:_SID() abort
    return matchstr(expand('<sfile>'), '<SNR>\zs\d\+\ze__SID$')
  endfunction
  execute join(['function! vital#_gitn#VCS#Git#import() abort', printf("return map({'_vital_depends': '', 'get_config': '', 'find': '', 'get_finder_cache': '', 'get_finder': '', 'set_config': '', 'new': '', '_vital_loaded': ''}, \"function('<SNR>%s_' . v:key)\")", s:_SID()), 'endfunction'], "\n")
  delfunction s:_SID
endif
" ___vital___
"******************************************************************************
