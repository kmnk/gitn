...
if v:version > 703 || v:version == 703 && has('patch1170')
  function! vital#_gitn#VCS#Git#Core#import() abort
    return map({'get_mode': '', 'find_worktree': '', 'is_rebase_merging': '', 'get_rebase_apply_step': '', 'get_rebase_merge_head': '', 'get_rebase_apply_head': '', 'get_remote_fetch': '', 'get_version': '', 'get_rebase_merge_step': '', 'get_fetch_head': '', 'is_reverting': '', 'is_cherry_picking': '', 'get_head': '', '_vital_depends': '', 'is_rebase_applying_rebase': '', 'get_branch_merge': '', 'get_comment_char': '', 'get_config': '', 'find_repository': '', 'is_rebase_merging_interactive': '', 'is_bisecting': '', 'get_revert_head': '', 'get_absolute_path': '', 'get_relative_path': '', 'system': '', 'get_local_hash': '', 'get_rebase_apply_total': '', 'get_orig_head': '', 'is_merging': '', 'set_config': '', 'get_remote_hash': '', 'is_rebase_applying': '', 'get_cherry_pick_head': '', 'get_remote_url': '', 'is_rebase_applying_am': '', 'get_branch_remote': '', 'get_bisect_log': '', 'get_repository_config': '', 'system_interactive': '', 'get_rebase_merge_total': '', 'exec': '', 'get_merge_head': '', 'get_commit_editmsg': '', 'get_merge_msg': '', '_vital_loaded': ''},  'function("s:" . v:key)')
  endfunction
else
  function! s:_SID() abort
    return matchstr(expand('<sfile>'), '<SNR>\zs\d\+\ze__SID$')
  endfunction
  execute join(['function! vital#_gitn#VCS#Git#Core#import() abort', printf("return map({'get_mode': '', 'find_worktree': '', 'is_rebase_merging': '', 'get_rebase_apply_step': '', 'get_rebase_merge_head': '', 'get_rebase_apply_head': '', 'get_remote_fetch': '', 'get_version': '', 'get_rebase_merge_step': '', 'get_fetch_head': '', 'is_reverting': '', 'is_cherry_picking': '', 'get_head': '', '_vital_depends': '', 'is_rebase_applying_rebase': '', 'get_branch_merge': '', 'get_comment_char': '', 'get_config': '', 'find_repository': '', 'is_rebase_merging_interactive': '', 'is_bisecting': '', 'get_revert_head': '', 'get_absolute_path': '', 'get_relative_path': '', 'system': '', 'get_local_hash': '', 'get_rebase_apply_total': '', 'get_orig_head': '', 'is_merging': '', 'set_config': '', 'get_remote_hash': '', 'is_rebase_applying': '', 'get_cherry_pick_head': '', 'get_remote_url': '', 'is_rebase_applying_am': '', 'get_branch_remote': '', 'get_bisect_log': '', 'get_repository_config': '', 'system_interactive': '', 'get_rebase_merge_total': '', 'exec': '', 'get_merge_head': '', 'get_commit_editmsg': '', 'get_merge_msg': '', '_vital_loaded': ''}, \"function('<SNR>%s_' . v:key)\")", s:_SID()), 'endfunction'], "\n")
  delfunction s:_SID
endif
" ___vital___
let s:save_cpo = &cpo
