...
if v:version > 703 || v:version == 703 && has('patch1170')
  function! vital#_gitn#VCS#Git#StatusParser#import() abort
    return map({'parse': '', 'is_staged': '', '_vital_created': '', 'is_ignored': '', 'parse_record': '', 'is_unstaged': '', 'is_untracked': '', 'is_conflicted': ''},  'function("s:" . v:key)')
  endfunction
else
  function! s:_SID() abort
    return matchstr(expand('<sfile>'), '<SNR>\zs\d\+\ze__SID$')
  endfunction
  execute join(['function! vital#_gitn#VCS#Git#StatusParser#import() abort', printf("return map({'parse': '', 'is_staged': '', '_vital_created': '', 'is_ignored': '', 'parse_record': '', 'is_unstaged': '', 'is_untracked': '', 'is_conflicted': ''}, \"function('<SNR>%s_' . v:key)\")", s:_SID()), 'endfunction'], "\n")
  delfunction s:_SID
endif
" ___vital___
"******************************************************************************
