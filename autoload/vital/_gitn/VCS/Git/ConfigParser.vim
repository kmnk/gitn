...
if v:version > 703 || v:version == 703 && has('patch1170')
  function! vital#_gitn#VCS#Git#ConfigParser#import() abort
    return map({'parse': '', 'parse_record': ''},  'function("s:" . v:key)')
  endfunction
else
  function! s:_SID() abort
    return matchstr(expand('<sfile>'), '<SNR>\zs\d\+\ze__SID$')
  endfunction
  execute join(['function! vital#_gitn#VCS#Git#ConfigParser#import() abort', printf("return map({'parse': '', 'parse_record': ''}, \"function('<SNR>%s_' . v:key)\")", s:_SID()), 'endfunction'], "\n")
  delfunction s:_SID
endif
" ___vital___
"******************************************************************************
