...
if v:version > 703 || v:version == 703 && has('patch1170')
  function! vital#_gitn#Text#INI#import() abort
  ...
  execute join(['function! vital#_gitn#Text#INI#import() abort', printf("return map({'parse': '', 'parse_record': '', 'parse_file': ''}, \"function('<SNR>%s_' . v:key)\")", s:_SID()), 'endfunction'], "\n")
  delfunction s:_SID
endif
" ___vital___
let s:save_cpo = &cpo
